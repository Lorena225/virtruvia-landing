        ...
        <div className="grid md:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <a href="https://www.instagram.com/matricula_ead" target="_blank" rel="noopener noreferrer"
                title="Siga o Matrícula EAD no Instagram" aria-label="Siga o Matrícula EAD no Instagram"
                className="text-gray-400 hover:text-white transition-colors text-sm flex items-center gap-3 group">
                <span className="w-6 h-6 flex items-center justify-center flex-shrink-0" aria-hidden="true">
              ...
              <a href="https://www.facebook.com/matriculaead" target="_blank" rel="noopener noreferrer"
                title="Curta o Matrícula EAD no Facebook" aria-label="Curta o Matrícula EAD no Facebook"
                className="text-gray-400 hover:text-white transition-colors text-sm flex items-center gap-3 group">
                <span className="w-6 h-6 flex items-center justify-center flex-shrink-0" aria-hidden="true">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5">
              ...
              {/* YouTube — vermelho oficial #FF0000 */}
              <a href="https://www.youtube.com/@MatriculaEaD" target="_blank" rel="noopener noreferrer"
                title="Assista aos vídeos do Matrícula EAD no YouTube" aria-label="Assista aos vídeos do Matrícula EAD no YouTube"
                className="text-gray-400 hover:text-white transition-colors text-sm flex items-center gap-3 group">
                <span className="w-6 h-6 flex items-center justify-center flex-shrink-0" aria-hidden="true">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5">
